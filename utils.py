...
from constants import bot, NightABot, pool, ADMIN_GROUP_ID, VIP, get_words_all, get_words_set, get_words_li
...
async def has_star(user_id: int) -> bool:
    return user_id in VIP or user_id == NightABot.id or await amt_donated(user_id)
